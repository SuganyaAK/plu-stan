...
- **Check:** Inspect functions like `mkValidator` or `mkPolicy` for checks on `txInfoSignatories`.
- **Risk:** Even if data is correct, the wrong person might be submitting it.
